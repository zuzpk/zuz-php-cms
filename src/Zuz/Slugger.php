...
public static function Build( $str = '' , $maxl = -1 , $trns = false ){
    
    $str	= self::utf8_clean( $str , true );	//True == $remove_bom
		
    $str	= self::utf8_strtolower( $str );
    ...
    if( $maxl > 0 )
    {
        ...
        $str	= self::utf8_substr( $str , 0 , $maxl );
    }
...
public static function utf8_strlen( $str ){
    ...
    return count( self::utf8_split( $str ) );
}
...
public static function utf8_clean( $str , $remove_bom = false ){    
    ...
    if( $remove_bom )
    {
        $str	= self::utf8_str_replace( self::utf8_bom( ) , '' , $str );
    }
...
public static function utf8_split( $str , $split_length = 1 ){
    $str	= ( string ) $str;
...
public static function utf8_chunk_split( $body , $chunklen = 76 , $end = "\r\n" ){
    return implode( $end , self::utf8_split( $body , $chunklen ) );
}
        
public static function utf8_fits_inside( $str , $box_size ){
    return ( self::utf8_strlen( $str ) <= $box_size );
}
    
    
public static function utf8_chr_size_list( $str ){
    return array_map( 'strlen' , self::utf8_split( $str ) );
}
    
    
public static function utf8_max_chr_width( $str )
{
    return max( self::utf8_chr_size_list( $string ) );
}
...
public static function utf8_single_chr_html_encode( $chr )
{
    return '&#' . self::utf8_ord( $chr ) . ';';
}
...
public static function utf8_html_encode( $str )
{
    return implode( array_map( 'utf8_single_chr_html_encode' , self::utf8_split( $str ) ) );
}
...
public static function utf8_substr( $str , $start = 0 , $length = NULL )
{
...
public static function utf8_bom( )
{
    return "\xef\xbb\xbf";
...
public static function utf8_file_has_bom( $file_path )
{
...
public static function utf8_string_has_bom( $str )
{
...
public static function utf8_add_bom_to_string( $str )
{
    if( !self::is_bom( substr( $str , 0 , 3 ) ) )
    {
        $str    = self::utf8_bom( ) . $str;
    }
...
public static function utf8_str_shuffle( $str )
{
    $array    = self::utf8_split( $str );
...
public static function utf8_count_chars( $str )    //there is no $mode parameters
{
    $array    = array_count_values( self::utf8_split( $str ) );
...
{
    return implode( array_reverse( self::utf8_split( $str ) ) );
}
...
public static function utf8_strpos( $haystack , $needle , $offset = 0 )
{
    //iconv and mbstring do not support integer $needle
    
    if( ( ( int ) $needle ) === $needle && ( $needle >= 0 ) )
    {
        $needle	= self::utf8_chr( $needle );
    }
    
    $needle	= self::utf8_clean( ( string ) $needle );
    ...
    $haystack	= self::utf8_clean( $haystack );
    ...
    if( $offset > 0 )
    {
        $haystack	= self::utf8_substr( $haystack , $offset );
    }
    ...
    if( ( $pos = strpos( $haystack , $needle ) ) !== false )
    {
        ...
        return ( $offset > 0 ? $offset : 0 ) + self::utf8_strlen( $left );
    }
...
public static function utf8_max( $arg )
{
    if( is_array( $arg ) )
    {
        $arg    = implode( $arg );
    ...
    return self::utf8_chr( max( self::utf8_codepoints( $arg ) ) );
}
...
public static function utf8_min( $arg )
{
    if( is_array( $arg ) )
    {
        $arg    = implode( $arg );
    ...
    return self::utf8_chr( min( self::utf8_codepoints( $arg ) ) );
}
...
public static function utf8_codepoints( $arg , $u_style = false )
{
    if( is_string( $arg ) )
    {
        $arg    = self::utf8_split( $arg );
    }
...
public static function utf8_int_to_hex( $int , $pfix = 'U+' )
{
...
public static function utf8_chr_to_hex( $chr , $pfix = 'U+' )
{
    return self::utf8_int_to_hex( self::utf8_ord( $chr ) , $pfix );
}
...
public static function utf8_word_count( $str )
{
    return count( explode( '-' , self::utf8_url_slug( $str ) ) );
}
...
public static function utf8_string( $array )
{
...
public static function utf8_substr_count( $haystack , $needle , $offset = 0 , $length = NULL )
{
    if( $offset || $length )
    {
        $haystack    = self::utf8_substr( $haystack , $offset , $length );
    }
...
public static function utf8_range( $var1 , $var2 )
{
    if( ctype_digit( ( string ) $var1 ) )
    {
        $start    = ( int ) $var1;
    }
    else if( !( $start = ( int ) self::utf8_hex_to_int( $var1 ) ) )
    {
    ...
    else if( !( $end = ( int ) self::utf8_hex_to_int( $var2 ) ) )
    {
        //if not u+0000 style codepoint
        
        if( !( $end    = self::utf8_ord( $var1 ) ) )
        {
            //if not a valid utf8 character
...
public static function utf8_hash( $len = 8 )
{
    Static $chrs        = array( );
 ...
 * @since 1.2
 * 
 * @param    string $callback The callback public static function
 * @param    string $str UTF-8 string to run callback on
 * @return   array The outcome of callback
*/

public static function utf8_chr_map( $callback , $str )
{
    $chrs    = self::utf8_split( $str );
...
public static function utf8_callback( $callback , $str )
{
    return self::utf8_chr_map( $callback , $str );
}
...
public static function utf8_access( $string , $pos )
{
    //return the character at the specified position: $str[1] like public static functionality
    
    return self::utf8_substr( $string , $pos , 1 );
}
...
public static function utf8_str_sort( $str , $unique = false , $desc = false )
{
    $array    = self::utf8_codepoints( $str );
...
public static function utf8_strip_tags( $string , $allowable_tags = '' )
{
    //clean broken utf8
    $string = self::utf8_clean( $string );
...
public static function utf8_str_replace( $search , $replace , $subject , &$count = 0 )
{
...
public static function utf8_str_repeat( $string , $multiplier )
{
...
public static function utf8_str_pad( $input , $pad_length , $pad_string = ' ' , $pad_type = STR_PAD_RIGHT )
{
    $input_length    = self::utf8_strlen( $input );
    
    if( is_int( $pad_length ) && ( $pad_length > 0 ) && ( $pad_length >= $input_length ) )
    {
        $ps_length    = self::utf8_strlen( $pad_string );
        ...
        {
            case STR_PAD_LEFT:
                    $pre    = self::utf8_str_repeat( $pad_string , ( int ) ceil( $diff / $ps_length ) );
                    $pre    = self::utf8_substr( $pre , 0 , $diff );
                    $post    = '';
                    
                    break;
                    
            case STR_PAD_BOTH:
                    $pre    = self::utf8_str_repeat( $pad_string , ( int ) ceil( $diff / $ps_length / 2 ) );
                    $pre    = self::utf8_substr( $pre , 0 , ( int ) $diff / 2 );
                    $post    = self::utf8_str_repeat( $pad_string , ( int ) ceil( $diff / $ps_length / 2 ) );
                    $post    = self::utf8_substr( $post , 0 , ( int ) ceil( $diff / 2 ) );
                    
                    break;
                    
            case STR_PAD_RIGHT:
            default:
                    $post    = self::utf8_str_repeat( $pad_string , ( int ) ceil( $diff / $ps_length ) );
                    $post    = self::utf8_substr( $post , 0 , $diff );
                    $pre    = '';
        }
...
public static function utf8_strrpos( $haystack , $needle , $offset = 0 )
{
    if( ( ( int ) $needle ) === $needle && ( $needle >= 0 ) )
    {
        $needle    = self::utf8_chr( $needle );
...
public static function utf8_remove_duplicates( $str , $what = ' ' )
{
    if( is_string( $what ) )
    {
        $what    = array( $what );
...
public static function utf8_ws( )
{
    Static $white = array( 
...
public static function utf8_trim_util( &$string , &$chrs )
{
    if( empty( $chrs ) )
    {
        $chrs    = self::utf8_ws( );
    ...
    {
        $chrs   = self::utf8_split( $chrs );
    }
    
    $chrs   = array_flip( $chrs );
    
    $string    = self::utf8_clean( $string );    //Cleanup is necessary here, or trim public static functions may break
}
...
public static function utf8_trim( $string = '' , $chrs = '' )
{
    $string    = self::utf8_ltrim( $string , $chrs );
    
    return self::utf8_rtrim( $string , $chrs );
}
...
public static function utf8_ltrim( $string = '' , $chrs = '' )
{
    self::utf8_trim_util( $string , $chrs );
    
    $s_look    = self::utf8_split( $string );
    ...
    return self::utf8_substr( $string , $count );
}
...
public static function utf8_rtrim( $string = '' , $chrs = '' )
{
    self::utf8_trim_util( $string , $chrs );
    ...
    return self::utf8_substr( $string , 0 , $len );
}
...
public static function utf8_strtolower( $str )
{
    ...
    if( empty( $table ) )
    {
        $table    = array_flip( self::utf8_case_table( ) );
    }
...
public static function utf8_case_table( )
{
    static $case = array(
...
{
    return self::utf8_strtoupper( self::utf8_substr( $str , 0 , 1 ) ) . self::utf8_substr( $str , 1 );
}
...
public static function utf8_lcfirst( $str )
{
    return self::utf8_strtolower( self::utf8_substr( $str , 0 , 1 ) ) . self::utf8_substr( $str , 1 );
}
...
{
    foreach( self::utf8_ws( ) as $ws )
    {
        $pos    = -1;
        
        while( true )
        {
            if( ( $pos = self::utf8_strpos( $str , $ws , $pos + 1 ) ) === false )
            {
                break;
            }
            
            $str    = self::utf8_substr( $str , 0 , $pos + 1 ) . self::utf8_strtoupper( self::utf8_substr( $str , $pos + 1 , 1 ) ) . self::utf8_substr( $str , $pos + 2 );
        }
    }
    
    return self::utf8_ucfirst( $str );
}
...
public static function utf8_stripos( $haystack , $needle , $offset = 0 )
{
    return self::utf8_strpos( self::utf8_strtolower( $haystack ) , self::utf8_strtolower( $needle ) , $offset );
}
...
public static function utf8_strripos( $haystack , $needle , $offset = 0 )
{
    return self::utf8_strrpos( self::utf8_strtolower( $haystack ) , self::utf8_strtolower( $needle ) , $offset );
}
